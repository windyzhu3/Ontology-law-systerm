...
class R1WorkerTransportIT extends ContactFlowFixture {
    ...
    final class Harness implements AutoCloseable {
        ...
        Harness()throws Exception {
            actor=service("R1_PROJECTION_CONSUME");var serverKeys=key("SERVER");var clientKeys=key("CLIENT");binding=binding(actor,clientKeys,"CLIENT");registry=new R1WorkerTenantBindings("MVP-2026-09-08.3",List.of(binding));
    ...
    @Test void registry_rejects_empty_duplicate_tenant_certificate_actor_and_wrong_release()throws Exception{
        ...
        assertThrows(IllegalArgumentException.class,()->new R1WorkerTenantBindings("MVP-2026-09-08.3",List.of()));
        assertThrows(IllegalArgumentException.class,()->new R1WorkerTenantBindings("MVP-2026-09-06.3",List.of(b)));
        assertThrows(IllegalArgumentException.class,()->new R1WorkerTenantBindings("MVP-2026-09-08.3",List.of(b,b)));
        assertThrows(IllegalArgumentException.class,()->new R1WorkerTenantBindings("MVP-2026-09-08.3",List.of(b,new R1WorkerTenantBindings.Binding(UUID.randomUUID(),UUID.randomUUID(),UUID.randomUUID(),"SECOND",b.certificateSha256()))));
    }
    @Test void real_mtls_readiness_calls_query_service_and_rejects_untrusted_or_mismatched_credentials()throws Exception{
        ...
        var serverKeys=key("SERVER");var clientKeys=key("CLIENT");var rogueKeys=key("ROGUE");var binding=binding(actor,clientKeys,"CLIENT");var registry=new R1WorkerTenantBindings("MVP-2026-09-08.3",List.of(binding));var calls=new AtomicInteger();
        ...
        var rogueBinding=binding(actor,rogueKeys,"ROGUE");var rogueRegistry=new R1WorkerTenantBindings("MVP-2026-09-08.3",List.of(rogueBinding));
