...
public class R1ApiDelegate implements CommandReceiptsApi,LeadsApi,TaskCommandsApi,TaskDraftsApi,WorkbenchApi {
    ...
    public ResponseEntity<ActionDraftWriteResult> saveActionDraft(UUID task,UUID key,SaveActionDraftV1 body,String match,String none,UUID xAppointmentId,UUID xOnBehalfAppointmentId){
    ...
    public ResponseEntity<DecisionRecordCommandReceipt> acknowledgeSourceIntakeStopRequest(UUID task,UUID key,String match,AcknowledgeSourceIntakeStopRequestV1 body,UUID xAppointmentId,UUID xOnBehalfAppointmentId){return primary(CommandEnvelope.Type.ACKNOWLEDGE_SOURCE_INTAKE_STOP_REQUEST,task,key,match,body,DecisionRecordCommandReceipt.class);}
